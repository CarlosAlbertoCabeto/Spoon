...
import { obtenerHorarios, actualizarHorarios } from '@/lib/firebase/horarios';
 ...
 * @typedef {'default' | 'firebase'} OrigenDatos
 */
type OrigenDatos = 'default' | 'firebase';
...
const VistaHorariosRestaurante: React.FC = () => {
  ...
  /**
   * Efecto para cargar los horarios iniciales desde Firebase
    ...
    const cargarHorarios = async () => {
      try {
        ...
        if (horariosGuardados?.horarioRegular) {
          ...
          setOrigenDatos('firebase');
          toast({
            title: "Datos cargados",
            description: "Se han cargado los horarios guardados en la base de datos",
          });
        } else {
  ...
  /**
   * Guarda los cambios de horarios en Firebase
                ...
                <div className="flex items-center gap-2 mt-1">
                  {origenDatos === 'firebase' ? (
                    <div className="flex items-center gap-1 text-sm text-green-600">
                      <Database size={16} />
                      <span>Datos cargados desde Firebase</span>
