...
const LoginPage = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (result.needsProfile) {
        toast.success('¡Bienvenido! Complete su perfil para continuar');
      ...
      toast.error(error.message || 'No se pudo completar el inicio de sesión con Google');
    } finally {
      setCargando(false);
    }
  };
  
  // Manejador para el envío del formulario de inicio de sesión con email/password
  const manejarEnvio = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await signInWithEmail(datosFormulario.correo, datosFormulario.contrasena);
      ...
      if (err.message) {
        ...
        mensajeError = 'Demasiados intentos fallidos. Por favor, intente más tarde';
      }
